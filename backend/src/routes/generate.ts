...
- Пиши так, будто отправитель лично посмотрел бизнес, сайт, профиль или страницу адресата.

Жесткие ограничения:
- Максимум 4-5 коротких предложений.
- Начало ОБЯЗАТЕЛЬНО только одно из: "Привет", "Смотрел", "Заметил", "Есть ощущение".
- Никогда не начинай с: "Здравствуйте", "Добрый день", "Нередко компании", "Многие компании", "Мы предлагаем", "Наша компания".
- 1 часть: личный hook, будто ты проверил сайт, профиль или бизнес ${target}.
- 2 часть: гипотеза проблемы, а не уверенное заявление.
- 3 часть: легкий insight, почему это может мешать.
- 4 часть: мягкий CTA.

Стиль:
- Как основатель пишет другому человеку.
- Как личное DM, не как презентация компании.
- Просто, коротко, без рекламного лоска.
- Немного живой и несовершенный язык — это нормально.
- ОБЯЗАТЕЛЬНО используй осторожную формулировку: "есть ощущение", "скорее всего" или "может быть".
- Должно звучать как личное наблюдение, а не массовая рассылка.
- Без корпоративного русского.
- Без маркетингового агентского тона.
- Без формального email-стиля.
- Не начинай с "Добрый день" или "Здравствуйте".
...
Хорошо:
Привет.
Смотрел, как у вас сделан сайт — есть ощущение, что не сразу понятно, в чем основная ценность.
Из-за этого часть людей может просто уходить.
Я сейчас как раз с такими штуками работаю.
Если хочешь, могу накинуть пару идей под ваш кейс.
  ...
  if (language === "russian") {
    if (previousMessage || followUpType) {
      return tone === "professional"
        ? `Заметил еще одну вещь по ${target}. Есть ощущение, что ${offer} можно проверить на одном маленьком участке, без больших изменений. Так быстрее понятно, есть ли смысл двигаться дальше. Открыты к короткому взгляду?`
        : `Заметил еще одну вещь по ${target}. Есть ощущение, что ${offer} можно проверить на одном маленьком участке. Так быстрее понятно, есть ли смысл. Показать, как это может выглядеть?`;
    }

    return tone === "professional"
      ? `Смотрел ${target}. Есть ощущение, что смысл оффера теряется в первых строках. Люди, скорее всего, уходят раньше. Я сейчас работаю с ${offer}, чтобы такие места были понятнее. Открыты к короткому взгляду?`
      : `Привет. Смотрел ${target}. Есть ощущение, что смысл оффера теряется в первых строках. Люди, скорее всего, уходят раньше. Я сейчас работаю с ${offer}. Показать пару идей?`;
  }
