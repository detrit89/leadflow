...
- Максимум 4-5 коротких предложений.
- Каждое предложение максимум 10-12 слов.
- Очень простой русский.
- Как будто человек быстро печатает в личку.
- Это должна быть быстрая мысль в чате, не структурированный питч.
- Не добавляй длинные объяснения.
- Не используй сложные слова.
- Тон слегка casual.
- Без сложных фраз и красивых формулировок.
- Разрешены простые слова, легкие повторы и casual тон.
- Должно звучать чуть несовершенно.
- Не полируй текст.
- Не делай его слишком ровным или рекламным.
- Не используй абстрактные слова: "ценность", "взаимодействие", "восприятие", "позиционирование", "коммуникация".
- Начало ОБЯЗАТЕЛЬНО только одно из: "Привет", "Смотрел", "Заметил", "Есть ощущение".
- Никогда не начинай с: "Здравствуйте", "Добрый день", "Нередко компании", "Многие компании", "Мы предлагаем", "Наша компания".
...
- Короткие фразы. Почти как в чате.
- Не звучать как готовая sales-структура.
- Пиши как короткую мысль, которую отправили сразу.
- Не пытайся звучать умно.
- Не звучать polished.
- Лучше чуть проще, чем красиво.
- Легкий повтор допустим, если звучит живо.
...
- Плохо: "воспринимают ваше предложение и взаимодействуют".
- Хорошо: "не сразу понятно, что вы предлагаете".
...
ЦА: владельцы сайтов
Оффер: аудит сайта
Плохо: Посетители по-разному воспринимают ваше предложение и взаимодействуют с контентом.
Почему плохо: слишком сложно и абстрактно.
...
Хорошо:
Привет.
Смотрел сайт — есть ощущение, что не сразу понятно, что вы предлагаете.
Из-за этого часть людей может просто уходить.
Я сейчас как раз с такими штуками работаю.
Могу накинуть пару идей под ваш кейс.
